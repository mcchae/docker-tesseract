...
"x86_64-linux-thread-multi-4.14.39-0-vanilla" or
	die "Errno architecture (x86_64-linux-thread-multi-4.14.39-0-vanilla) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
